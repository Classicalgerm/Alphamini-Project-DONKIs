...
#using sence for detecting the distance
...
#configuration
SERIAL_SUFFIX = "213"  #put the correct ID
STEP_SIZE = 1  # default step size for forward
BACKWARD_STEPS = 2  #step size for moving backward also to avoid the obstacle
SLEEP_DURATION = 1
